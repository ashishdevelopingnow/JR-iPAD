...
//        Utils.showAlert(withMessage: message, andTitle: title)
        ...
        fcAlert.showAlert(inView: ((UIApplication.shared.keyWindow?.rootViewController as! UINavigationController).visibleViewController)!, withTitle: title ?? Constants.APP_NAME, withSubtitle: message ?? "" , withCustomImage: image, withDoneButtonTitle: "OK", andButtons: nil)
