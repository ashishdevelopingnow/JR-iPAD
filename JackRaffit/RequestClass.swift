...
class RequestClass: NSObject {
    ...
    struct apis {
        ...
        static let baseURL = "http://stage.jackraffit.com/apis/"
//        static let baseURL = "http://m.jackraffit.com/apis/"
        
        static let listOfRaffle = "ipad_raffle_lists"
        ...
        static let raffitPayment = "ipad_stripe_payment"
    }
...
//        let almore = Alamofire.request(urlString, method: .POST, parameters: parameters, encoding: .JSON, headers: nil)
        ...
        if let auth =  UserDefault.getUserAuthentification() as? String {
            headers   = [
                "Authorization": auth,
       ...
       let almore = Alamofire.request(urlString, method: .post, parameters: parameters, encoding: JSONEncoding.default, headers: headers)
